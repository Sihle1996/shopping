...
@Component({
  ...
  template: `
    <div
      class="group bg-white rounded-2xl overflow-hidden brand-border-light brand-border-hover shadow-card hover:shadow-lg
             transition-all duration-300 cursor-pointer animate-fade-in border"
