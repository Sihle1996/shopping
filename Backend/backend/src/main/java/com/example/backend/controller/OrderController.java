...
public class OrderController {
    ...
    public ResponseEntity<?> trackOrder(@PathVariable UUID orderId,
        ...
        // SECURITY: never expose deliveryOtp (the delivery-handoff secret) on this public
        // track endpoint — anyone with the orderId + guest email could otherwise read it.
